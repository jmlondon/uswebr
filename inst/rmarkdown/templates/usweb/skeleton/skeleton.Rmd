...
This template includes support for Mathjax equations. There are inline equations such as $y_i = \alpha + \beta x_i + e_i$. But, we can also specify centered forumla for more complex equations.
