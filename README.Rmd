...
An R package that includes an RMarkdown template (currently) targeted for scientific 
reports and documentation using the `bookdown` package's `html_document2` function. The look and feel is based on the 
