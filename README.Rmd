...
An R package that includes an RMarkdown template (currently) targeted for
...
with Section 508 of the Rehabilitation Act. Plots and other elements added
by the user should continue to follow accessiblity guidelines.
